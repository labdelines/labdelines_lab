...
const WorkspaceBookingPage = ({ workspaceKey = "think tank" }) => {
  ...
  // Workspace-specific data (you can move this to config if needed)
  const workspaceData = {
    "think tank": {
      image: "/images/think-tank.jpg",
      capacity: "12-25",
      features: [
        "Comfortable seating for 12-25 people, with flexible arrangements including theatre-style, U-shape, and classroom configurations",
        "Audio-visual equipment for presentations and discussions",
        "A whiteboard for capturing ideas and strategies",
        "Modern furniture and bright windows create a stimulating and inspiring atmosphere",
      ],
      amenities: [
        {
          icon: <Users className="w-5 h-5" />,
          title: "Flexible seating arrangements",
          desc: "U-shaped configuration, Horseback style seating (70 people max), Theater-style seating, Classroom-style seating",
        },
        {
    ...
    "share hives": {
      ...
      capacity: "Open",
      features: [
        "Collaborative workspace for teams and individuals",
        "Open space design promoting creativity and networking",
        "Co-working environment with cafe services",
        "Perfect for freelancers and creative professionals",
      ],
      amenities: [
        {
          icon: <Users className="w-5 h-5" />,
          title: "Community Space",
          desc: "Network with like-minded professionals",
        },
        {
          icon: <Coffee className="w-5 h-5" />,
          title: "Cafe Services",
          desc: "Full coffee shop and light meals",
        },
        {
          icon: <Wifi className="w-5 h-5" />,
          title: "Fast Wi-Fi",
          desc: "Enterprise-grade internet connection",
        },
      ],
    },
    underlines: {
