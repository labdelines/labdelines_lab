...
import focus_capsule from "@/public/assets/focus_capsule.jpg";
...
const FocusCapsule = () => {
  ...
  const roomConfig = BookingUtils.getRoomConfig("focus capsule");
  const roomFeatures = RoomFeatures["focus capsule"] || [];
  const roomAmenities = RoomAmenities["focus capsule"] || [];
  ...
  const loadBookingData = async () => {
    try {
      ...
      console.log("Loading Focus Capsule booking data...");
      const allBookings = await BookingUtils.loadBookingData();

      // Filter for Focus Capsule bookings only
      const focusCapsuleBookings = BookingUtils.filterBookingsForRoom(
        allBookings,
        "focus capsule"
      );

      setBookings(focusCapsuleBookings);
      console.log(
        "Focus Capsule bookings loaded:",
        focusCapsuleBookings.length
      );
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4  sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 animate-fade-in-point">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden  delay-100">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {roomConfig.description}. Perfect for groups of 2-5 people
                  seeking privacy and productivity in a dedicated workspace
                  environment.
                </p>
            ...
            {/* Booking Calendar - Visible only on smaller screens (lg:hidden) */}
          ...
          <div className="space-y-6">
            {/* Booking Calendar - Visible only on larger screens (hidden lg:block) */}
